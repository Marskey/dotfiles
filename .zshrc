...
# Use Powerlevel10k when installed; otherwise use Oh My Zsh's default theme.
P10K_THEME_FILE="${ZSH_CUSTOM:-$ZSH/custom}/themes/powerlevel10k/powerlevel10k.zsh-theme"
